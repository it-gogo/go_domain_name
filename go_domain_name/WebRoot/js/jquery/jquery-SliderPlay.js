...
(function(window, $) { 
	$.fn.sliderPlay = function(options) {
		options = $.extend({
				...
				isShowTitle: true,	//是否开启标题,开启则采用img标签alt的文字
		...
		//获得banner层div
		var banner=$('.bannerBg');
		banner.stop().hide().fadeTo(0, 0).css('background', 'url(../upload/20141224_1.png) top center').fadeTo(600, 1);
		...
		function tabBg(num) {
			...
			case 0:
			    ...
			    break;
			case 1:
			    banner.stop().hide().fadeTo(0, 0).css('background', 'url(../upload/20141224_2.png) top center').fadeTo(600, 1);
			    break;
			case 2:
			    banner.stop().hide().fadeTo(0, 0).css('background', 'url(../upload/20141224_3.png) top center').fadeTo(600, 1);
			    break;
            case 3:
                banner.stop().hide().fadeTo(0, 0).css('background', 'url(../upload/20141023_bg.png) top center').fadeTo(600, 1);
                break;
			}
	    }
