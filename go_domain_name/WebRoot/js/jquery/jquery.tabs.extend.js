...
$.extend($.fn.tabs.methods, {
    ...
    loadTabIframe:function(jq,params){
        return jq.each(function(){
            ...
            var $maskMessage = $('<div class="mask-message" style="z-index:3;width:auto;height:16px;line-height:16px;position:absolute;top:50%;left:50%;margin-top:-20px;margin-left:-92px;padding: 12px 5px 10px 30px;">' + (params.iframe.message || '') + '</div>').appendTo($tabBody);
