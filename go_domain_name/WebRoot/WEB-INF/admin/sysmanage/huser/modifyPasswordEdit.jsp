  ...
  <body>
    ...
    <table width="100%" class="t2">
	    	     <tr>
	    			...
	    			<td>
	    			<input class="easyui-validatebox" type="password" name="password" id="password" data-options="required:true" style="width: 180px;" />
	    			 <span id="otip"></span>
	    			</td>
	    		</tr>
	    	    <tr>
	    		...
	    		<tr>
	    			...
	    			<td>
	    			<input class="easyui-validatebox" type="password" name="newpw1" id="newpw1" data-options="required:true" style="width: 180px;" />
	    			<span id="tip"></span>
	    			</td>
	    		</tr>
	    		</table>
