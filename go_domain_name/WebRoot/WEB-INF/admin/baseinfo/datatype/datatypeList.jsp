...
<div id="toolbar" style="height:28px;">
	...
	<input  id="mcode_right" type="hidden" >
		&nbsp; &nbsp; &nbsp;&nbsp;<input class="easyui-textbox" name="name" id="name_like" data-options="prompt:'请输入名称'" style="height:25px" plain="true" >
...
<table id="grids"   class="easyui-datagrid"   toolbar="#toolbar" pagination="true"  fit="true"  url="hdatatypeAction!ajaxList.action"
