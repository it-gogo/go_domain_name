...
.msg_ng {
	width: 550px;
	min-height: 220px;
	background: url(<%=request.getContextPath() %>/css/client/images/msg_ng.jpg) no-repeat;
	position: relative;
	zoom: 1;
}
...
.msg_ok {
	width: 550px;
	min-height: 220px;
	background: url(<%=request.getContextPath() %>/css/client/images/msg_ok.jpg) no-repeat;
	position: relative;
	zoom: 1;
}
...
#href {
	...
	width: 72px;
	height: 28px;
	background: url(<%=request.getContextPath() %>/css/client/images/jumpbg.jpg) no-repeat center;
	text-align: center;
